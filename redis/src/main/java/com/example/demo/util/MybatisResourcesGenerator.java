...
public class MybatisResourcesGenerator {
     ...
     * jdbc配置。自行修改
     */
    private static final String JDBC_MYSQL = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=true&serverTimezone=Asia/Shanghai&useTimezone=true";
